...
public class CreateRecordRequest extends Request<JSONObject> {
    private Map<String, String> params;
    Listener listener;
    private final String mMimeType;
    private final byte[] mMultipartBody;
//    static  String url = Config.url+"public/api/record/create-record-test";
    static String urlTail = "public/api/record/create-record-test";

    public CreateRecordRequest(int method, Map<String, String> params, Listener listener, String mimeType, byte[] multipartBody, String urlHead){
