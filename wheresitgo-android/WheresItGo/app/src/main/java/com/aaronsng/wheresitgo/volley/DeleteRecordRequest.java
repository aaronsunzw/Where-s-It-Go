...
public class DeleteRecordRequest extends Request<JSONObject> {

    private Map<String, String> params;
    DeleteRecordRequest.Listener listener;
//    static  String url = Config.url+"public/api/record/delete-record";
    static  String urlTail = "public/api/record/delete-record";


    public DeleteRecordRequest(int method, Map<String, String> params, DeleteRecordRequest.Listener listener, String urlHead){
