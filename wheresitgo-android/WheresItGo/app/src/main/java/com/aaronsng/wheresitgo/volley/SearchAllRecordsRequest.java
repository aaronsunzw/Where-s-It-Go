...
public class SearchAllRecordsRequest extends Request<JSONObject> {
    private Map<String, String> params;
    SearchAllRecordsRequest.Listener listener;
    //    static  String url = Config.url+"public/api/record/search-all-records";
    static  String urlTail = "public/api/record/search-all-records";
    ArrayList<Record> recordArrayList = new ArrayList<Record>();
    private Context appContext;

    public SearchAllRecordsRequest(int method, Map<String, String> params, SearchAllRecordsRequest.Listener listener, String urlHead){
